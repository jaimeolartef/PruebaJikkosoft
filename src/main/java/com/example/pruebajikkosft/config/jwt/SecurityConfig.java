...
public class SecurityConfig {
    ...
    public SecurityConfig(UsuarioService userDetailsService, JwtAuthFilter jwtAuthFilter) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        ...
        return http
                ...
                .headers(headers -> headers.frameOptions().disable()) // Para que funcione H2 Console
                .build();
    }
